...
const Skills = () => {
  return (
    <div name='skills' className='w-full h-full sm:h-screen bg-[#0a192f] text-gray-300 py-10 '>
      {/* Container */}
      <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
          <div>
              <p className='text-4xl font-bold inline border-b-4 border-primaryBlue '>Skills</p>
              {/* <p className='py-4'>// These are the technologies I've worked with</p> */}
          </div>

          <div className='w-full grid grid-cols-3 sm:grid-cols-6 sm:gap-6 sm:pt-10 gap-4 text-center py-8'>
              ...
              <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
                  ...
                  <p className='my-4'>Arduino and IOT</p>
              </div>
              <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
